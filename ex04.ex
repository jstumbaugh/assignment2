...
defmodule Ex04 do
  ...
  defp even_odd_func(num, {even_list, odd_list}) do
    cond do
      Integer.is_even num -> { [ num | even_list ], [ odd_list ] }
      Integer.is_odd  num -> { [ even_list ], [ num | odd_list ] }
    end
  end

  def even_odd(list), do: reduce(list, [], &even_odd_func/2)
